...
namespace WebApi.Migrations
{
    ...
    [Migration("20210316094531_addFieldIsPartsFromGMToScheduletable")]
    partial class addFieldIsPartsFromGMToScheduletable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Models.GrMScheduleModel", b =>
                {
                    b.Property<int>("ScheduleId")
                        .HasColumnType("int");

                    b.Property<int>("GrMeetingId")
                        .HasColumnType("int");

                    b.HasKey("ScheduleId", "GrMeetingId");

                    b.HasIndex("GrMeetingId");

                    b.ToTable("GrMSchedule");
                });

            modelBuilder.Entity("WebApi.Models.GrMUserModel", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApi.Models.GroupMeetingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApi.Models.GrMScheduleModel", b =>
                {
                    b.HasOne("WebApi.Models.GroupMeetingModel", "GroupMeeting")
                        .WithMany("GrMSchedules")
                        .HasForeignKey("GrMeetingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
